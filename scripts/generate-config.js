...
// Respect an explicitly set empty string for APPS_SCRIPT_URL (so the client
// can disable server fallback). Use default only when the env var is undefined.
...
// Normalize common mistaken values: remove trailing `/rest/v1` and trailing slash
...
const SUPABASE_URL_NORMALIZED = normalizeSupabaseUrl(SUPABASE_URL);

const content = `// Auto-generated config.js — do not edit by hand\n` +
`const SUPABASE_URL = ${JSON.stringify(SUPABASE_URL_NORMALIZED)};\n` +
